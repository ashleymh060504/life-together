              ...
              <div class="col">
                <div class="collapse multi-collapse" id="multiCollapseExample2">
                  <div class="card card-body">
                    ...
                    there, you can create a new group and invite groupmates to
                    get started. With LIFE TOGETHER, you can select and assign
                    tasks to groupmates, create new tasks, delete tasks, change
                    task deadlines as well as monitor and update the progress
                    status of a task.
                  </div>
                </div>
              </div>
