...
function Chores() {
    ...
    const getCompletedChores = async () => {
        try {
            const response = await fetch('http://localhost:3001/api/chores/completed');
            const data = await response.json();
    ...
    const deleteChore = async (id) => {
        try {
            const response = await fetch(`http://localhost:3001/api/chores/${id}`, {
                method: 'DELETE'
            });
            ...
            <div className='text-center mt-4'>COMPLETE</div>
                <div className="container text-center mt-2 border-test">
                    <table className="table table-hover mt-3">
                        ...
                        <tbody>
                            {(Array.isArray(completedChores) ? completedChores : [])
                                .sort((a, b) => new Date(a.deadline) - new Date(b.deadline))
